        ...
        <div className="hero-info">
          <div className="hero-matter">
            ...
            <p className="description">
              ...
              <br />
              <br />
              Our culinary team, led by renowned chefs, creates masterpieces on
              every plate. From locally sourced ingredients to international
              culinary techniques, we bring you dishes that are not only
              delicious but also a work of art.
            </p>
          </div>
